...
<div id="main">
    <table  width="100%" border="1" cellspacing="0" cellpadding="0" style="margin-left: 0px;font-family: 宋体;border: none" >
        <thead style="background-color: #EEEEED;font-size: 14px;font-weight:100;border: none"><tr><th>申请人</th><th>电话</th><th>开始时间</th><th>结束时间</th><th>商品批次序号</th><th>奖品配置</th><th>活动状态<div style="font-size: 10px">（1表示进行中，2表示已结束）</div> </th></tr></thead>
