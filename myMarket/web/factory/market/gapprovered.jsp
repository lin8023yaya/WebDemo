...
<div id="main">
    <table  width="100%" border="1" cellspacing="0" cellpadding="0" style="margin-left: 0px;margin-top: 0px;font-family: 宋体;border: none" >
        <thead style="background-color: #EEEEED;border: none;font-size: 14px"><tr><th>红包奖品配置序号</th><th>申请人</th><th>电话</th><th>开始时间</th><th>结束时间</th><th>商品生产批次号</th><th>操作 </th></tr></thead>
        ...
        <c:forEach items="${applyredpacket}" var="approve" varStatus="status"  >
            <tr style="margin-top: 0px" class="${approve.bid}">
                ...
                <th><p style="color: #0000cc;cursor: pointer" onclick="send(this.id)" id="${approve.bid}">通过</p></th>
            </tr>
        </c:forEach>
        </tbody>
    </table>
