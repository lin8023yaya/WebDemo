...
<head>
  ...
  <script >
      ...
      $(function(){
          timerClearDiv();
          $("#gridTable").jqGrid({
              url: '<s:url action="test" escapeAmp="false" namespace="/json"/>',
              datatype: "json",
              mtype:"POST",//提交方式
              postData:{
                  //参数
              ...
              page:$("#page").val(),
              colModel:[
                  {name:'id',label:'id',index:'productname', width:100},
                  {name:'name',label:'姓名',index:'codecnt', width:80},
                  {name:'age',label:'年龄',index:'scannum', width:70},
                  {
                      name:'sex',
                      label:'性别',
                      index:'scancnt',
...
<div class="manageaccountlist-main" id="loadingdiv">
  ...
  <div id="manageaccountlist-main">
    <div class="manageaccountlist-create">
      <div id="manageaccountlist-create-title">测试数据</div>
    </div>
