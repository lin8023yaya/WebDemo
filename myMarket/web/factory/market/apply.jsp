...
<script>
    ...
    function apply() {
        ...
        if(radiovalue=="2"){
            ...
            $.ajax({
                url: "http://localhost:8010/batchbound",
                data:{productid:typeId,batchid:batch,vendorid:vendorID,starttime:starttime,endtime:endtime,name:name,tel:tel,redpacketinfoid:redpacketinfoid},
                dataType:'jsonp',
                // processData: false,
                type:'get',
                jsonpCallback:"callback",
